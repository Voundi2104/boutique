...
<link rel="stylesheet" type="text/css" href="<?php echo base_url().'../../../assets/boutiqueClient/styles/checkout.css';?>">
<link rel="stylesheet" type="text/css" href="<?php echo base_url().'../../../assets/boutiqueClient/styles/checkout_responsive.css';?>">
</head>
<body>
...
<div class="super_container">
	...
	<div class="home">
		<div class="home_container">
			<div class="home_background" style="background-image:url(<?php echo base_url().'../../../assets/boutiqueClient/images/cart.jpg)';?>"></div>
							...
							<form action="#" id="checkout_form" class="checkout_form">
								...
								<div class="checkout_extra">
									<div>
										...
										<label for="checkbox_terms"><img src="<?php echo base_url().'../../../assets/boutiqueClient/images/check.png';?>" alt=""></label>
									...
									<div>
										...
										<label for="checkbox_account"><img src="<?php echo base_url().'../../../assets/boutiqueClient/images/check.png';?>" alt=""></label>
									...
									<div>
										...
										<label for="checkbox_newsletter"><img src="<?php echo base_url().'../../../assets/boutiqueClient/images/check.png';?>" alt=""></label>
